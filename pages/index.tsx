            ...
            <div className="w-row">
              <div className="column-6 w-col w-col-6">
                ...
                <div className="div-block-8">
                  <img
                    ...
                    loading="lazy"
                    srcSet="/images/presented-by-hodge-bigly-p-500.png 500w, /images/presented-by-hodge-bigly-p-800.png 800w, /images/presented-by-hodge-bigly-p-1080.png 1080w, /images/presented-by-hodge-bigly-p-1600.png 1600w, /images/presented-by-hodge-bigly-p-2000.png 2000w, /images/presented-by-hodge-bigly-p-2600.png 2600w, /images/presented-by-hodge-bigly.png 3138w"
                    sizes="100vw"
                ...
                <div className="div-block-10">
                  ...
                  >
                    <iframe
                      src="https://www.youtube.com/embed/3tgjwAbWxto?rel=0&controls=1&autoplay=0&mute=0&start=0"
                      frameBorder={0}
                      style={{
                        position: "absolute",
                        left: 0,
              ...
              <div id="TOP_OF_FORM" className="column-4 column-7 w-col w-col-6">
                <div className="div-block-30">
                  <div>
                    <img
                      src="/images/SquarePick-a-Truck-1-both.jpg"
                      loading="lazy"
                      alt=""
                    />
                  </div>
                  ...
                  {/* This is the form one component............ */}
          ...
          <div className="container-11 w-container">
            ...
            <div className="div-block-101">
              <div className="text-block-8">
                ...
                <div>
                  <span className="redtext boldtext">6.6L DURAMAX® </span> TURBO
                  DIESEL ENGINE
                </div>
                <div>
                  <span className="redtext boldtext">‍BOSE® PREMIUM</span> SOUND
                  SYSTEM
                </div>
                <span className="redtext boldtext">
            ...
            <div className="div-block-102">
              <img
                src="/images/IMG_2224.jpg"
                loading="lazy"
                id="w-node-_7d1132e3-1014-87e7-f0c0-af898bf40f75-54e32a56"
                className="item"
                alt=""
              />
              <img
                src="/images/chevy-5.jpg"
                loading="lazy"
                id="w-node-_960b0eb2-a2dc-c000-56b0-e805cac1f033-54e32a56"
                className="item"
                alt=""
              />
              <img
                ...
                loading="lazy"
                id="w-node-_2846fb10-4926-e95a-1a01-852c32562584-54e32a56"
                className="item"
                alt=""
              />
              <div className="item">
                <div
                  id="w-node-_0942b1bb-6d92-8f62-03a4-183614719413-54e32a56"
                ...
                <img
                  src="/images/vegas-truck-shoot-4-plate.jpg"
                  loading="lazy"
                  id="w-node-_8bd4681f-3a6f-33a3-730a-dac0de4c8e0d-54e32a56"
                  alt=""
                />
              </div>
            </div>
            ...
            <div className="div-block-11">
              ...
              <div className="div-block-103">
                <img
                  src="/images/Giveaway---Gladiator.png"
                  loading="lazy"
                  id="w-node-f6f0deee-7da3-9435-7347-4883fd529d53-54e32a56"
                  srcSet="/images/Giveaway---Gladiator.png 500w, /images/Giveaway---Gladiator.png 800w"
                  sizes="100vw"
                  alt=""
                />
                <img
                  src="/images/Giveaway---TRX.png"
                  loading="lazy"
                  id="w-node-_33f5c94d-3c14-1567-6934-632eb69d647d-54e32a56"
                  srcSet="/images/Giveaway---TRX.png 500w, /images/Giveaway---TRX.png 800w"
                  sizes="100vw"
                  alt=""
                />
                <img
                  src="/images/Giveaway---Stefanie.png"
                  loading="lazy"
                  id="w-node-_8f28ad67-5adb-969f-84b8-c78941ce8535-54e32a56"
                  srcSet="/images/Giveaway---Stefanie.png 500w, /images/Giveaway---Stefanie.png 800w"
                  sizes="100vw"
                  alt=""
                />
                <img
                  src="/images/Giveaway---Raptor.png"
                  loading="lazy"
                  id="w-node-_674dc522-0478-8f95-aa7d-8dba9283b744-54e32a56"
                  srcSet="/images/Giveaway---Raptor.png 500w, /images/Giveaway---Raptor.png 800w"
                  sizes="100vw"
                  alt=""
                />
              </div>
                  ...
                  <div className="div-block-108 customeNone">
                    <ul role="list" className="list-5">
                      <li className="accordianlist">
                        ...
                        No gimmicks! You support the Twins and we give back to
                        our fans!
                      </li>
                      <li className="accordianlist">
                  ...
                  <div className="div-block-108 customeNone">
                    <ul role="list" className="list-5">
                      <li className="accordianlist">
                        ...
                        kidding. <a href="tel:877-4624459(462-4459)" />
                      </li>
                      <li className="accordianlist">
        ...
        <div className="section-4 wf-section">
          <div className="w-container">
            ...
            <div className="div-block-16">
              ...
              >
                <iframe
                  src="https://www.youtube.com/embed/_rCqBqFxiFE?rel=0&controls=1&autoplay=0&mute=0&start=0"
                  frameBorder={0}
                  style={{
                    position: "absolute",
                    left: 0,
                ...
                <div className="div-block-26">
                  <ul role="list" className="list-4">
                    <li className="list-item-9">
                      <span className="boldtext">Monthly Coupons:</span> VIP
                ...
                <div className="div-block-27">
                  <ul role="list" className="list-3">
                    <li className="list-item-10">
                      <span className="boldtext">Exclusive Discounts: </span>Get
              ...
              <div className="column-3 w-col w-col-6">
                <div className="div-block-21">
                  <img
                    ...
                    loading="lazy"
                    srcSet="/images/club-banner-funnel-png-transparent-1--p-500.png 500w, /images/club-banner-funnel-png-transparent-1-.png 668w"
                    sizes="100vw"
